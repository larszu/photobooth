...
class SimpleGPIO {
    ...
    async initialize() {
        try {
            ...
            // Button Pin als Input mit Pull-Down konfigurieren (für Hardware: 3.3V→Button→GPIO17)
            const claimResult = lgpio.gpioClaimInput(this.handle, this.buttonPin, lgpio.SET_PULL_DOWN || 0);
            console.log('🔧 GPIO Claim Input Result (mit Pull-Down):', claimResult);
